...
var Bet = function(poloniex, orderBook, buyPrice, buyAmount, sellPrice, sellAmount) {
  this.status = "open"; // can also be failed, completed, cancelled
  ...
  poloniex.buy(orderBook.currencyOut, orderBook.currencyIn,
    this.buyPrice, this.buyAmount, buyOrderCallback);
  poloniex.sell(orderBook.currencyOut, orderBook.currencyIn,
    this.sellPrice, this.sellAmount, sellOrderCallback);
